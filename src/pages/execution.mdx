...
The way we plan, and execute in construction is broken. Established in the 1960s, the way we plan and execute hasn’t fundamentally changed, with one exception: the individuals creating and managing the plan.
